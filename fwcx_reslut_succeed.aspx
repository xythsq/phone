<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fwcx_reslut_succeed.aspx.cs" Inherits="WapCoovee.fwcx_reslut_succeed" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="./chengshengfiles/layer.css" media="all">
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: center; padding: 10px">
            <img id="simg" src="./chengshengfiles/success.png" style="width: 18%">
        </div>
        <div style="text-align: center; font-size: 1.8rem;"><%=anticode %></div>
        <div style="text-align: -webkit-center;">
            <div id="resluttxt" style="text-align: left; width: 90%; padding: 10px; margin: 10px 0px; border: 1px solid #E0D1B4; color: #663A24; box-sizing: border-box;">您所查询的是勐海陈升茶业有限公司生产的正牌产品编码，感谢您对陈升茶业品质的关心和认可，谢谢查询！
                <br data-filtered="filtered">
                查询记录：<br data-filtered="filtered">
                <%=queryLogHtml %>
            </div>
        </div>
